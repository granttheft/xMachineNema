...
namespace XMachine.Persistence.Operational.Migrations
{
    ...
    [Migration("20260502205511_AddPlanningModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XMachine.Module.Engineering.Domain.MachineFault", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("machine_faults", "engineering");
                });

            modelBuilder.Entity("XMachine.Module.Engineering.Domain.MaintenanceWorkOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "WorkOrderStatus");

                    b.ToTable("maintenance_work_orders", "engineering");
                });

            modelBuilder.Entity("XMachine.Module.Engineering.Domain.PreventiveMaintenanceSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("LastDoneAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasIndex("TenantId", "NextDueAt");

                    b.ToTable("pm_schedules", "engineering");
                });
            ...
            modelBuilder.Entity("XMachine.Module.Planning.Domain.PlanSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "PlannedStartAt");

                    b.HasIndex("TenantId", "ProductionPlanId");

                    b.HasIndex("TenantId", "SlotStatus");

                    b.ToTable("plan_slots", "planning");
                });

            modelBuilder.Entity("XMachine.Module.Planning.Domain.ProductionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "PlanNo")
                        .IsUnique();

                    b.HasIndex("TenantId", "PlanStatus");

                    b.HasIndex("TenantId", "PlannedStartAt");

                    b.ToTable("production_plans", "planning");
                });
            ...
            modelBuilder.Entity("XMachine.Module.Platform.Domain.TenantTranslationOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "LanguageCode", "Key")
                        .IsUnique();

                    b.ToTable("tenant_translation_overrides", "platform");
                });

            modelBuilder.Entity("XMachine.Module.Production.Domain.JobExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("PauseNotes")
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)")
                        .HasColumnName("pause_notes");
                    ...
                    b.HasIndex("TenantId", "ExecutionStatus");
                    ...
                    b.ToTable("job_executions", "production");
                });

            modelBuilder.Entity("XMachine.Module.Production.Domain.OperatorDeclaration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "DeclaredAt");

                    b.HasIndex("TenantId", "JobExecutionId");

                    b.HasIndex("TenantId", "OperatorId");

                    b.ToTable("operator_declarations", "production");
                });
            ...
            modelBuilder.Entity("XMachine.Module.Workflow.Domain.WorkflowAction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "WorkflowInstanceId", "ActionTime");

                    b.ToTable("workflow_actions", "workflow");
                });

            modelBuilder.Entity("XMachine.Module.Workflow.Domain.WorkflowDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XMachine.Module.Workflow.Domain.WorkflowInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("XMachine.Module.Workflow.Domain.WorkflowStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "WorkflowDefinitionId", "SequenceNo")
                        .IsUnique();
            ...
            modelBuilder.Entity("XMachine.Module.Engineering.Domain.MachineFault", b =>
                {
                    ...
                    b.HasOne("XMachine.Module.Engineering.Domain.MaintenanceWorkOrder", null)
                        .WithMany()
            ...
            modelBuilder.Entity("XMachine.Module.Planning.Domain.PlanSlot", b =>
                {
                    b.HasOne("XMachine.Module.Planning.Domain.ProductionPlan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("XMachine.Module.Production.Domain.OperatorDeclaration", b =>
                {
                    b.HasOne("XMachine.Module.Production.Domain.JobExecution", null)
                        .WithMany()
            ...
            modelBuilder.Entity("XMachine.Module.Workflow.Domain.WorkflowAction", b =>
                {
                    ...
                    b.HasOne("XMachine.Module.Workflow.Domain.WorkflowInstance", null)
                        .WithMany()
                        .HasForeignKey("WorkflowInstanceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XMachine.Module.Workflow.Domain.WorkflowStep", null)
                        .WithMany()
            ...
            modelBuilder.Entity("XMachine.Module.Workflow.Domain.WorkflowInstance", b =>
                {
                    b.HasOne("XMachine.Module.Workflow.Domain.WorkflowDefinition", null)
                        .WithMany()

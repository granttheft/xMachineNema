...
internal sealed class ModuleConfiguration : IEntityTypeConfiguration<CommercialModule>
{
    public void Configure(EntityTypeBuilder<CommercialModule> builder)
    {
        builder.ToTable("modules", "commercial");
